...
st.image("https://images.unsplash.com/photo-1552422535-c45813c61732", caption="Music is Life")
...
with tab1:
    st.header("나의 연주")
    st.write("제가 연주한 쇼팽 곡을 감상해보세요.")
    # 유튜브 영상 예시 (나중에 선생님 영상 주소로 바꾸면 돼요!)
    st.video("https://www.youtube.com/watch?v=9E6b3swbnWg")
